...
struct XIREMIX_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct XIREMIX_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct XIREMIX_API FSkelMeshMergeUVTransformMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct XIREMIX_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
        TArray < FSkelMeshMergeUVTransformMapping_BP > UVTransformsPerMesh;
...
*/
UCLASS()
class XIREMIX_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
