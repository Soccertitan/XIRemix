...
#include "XIAsyncTaskCooldownChanged.generated.h"
...
class XIREMIX_API UXIAsyncTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UXIAsyncTaskCooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
	...
	UFUNCTION(BlueprintCallable, Category = "XIAsyncTaskCooldownChanged")
