...
#include "XIAsyncTaskGameplayTagChanged.generated.h"
...
class XIREMIX_API UXIAsyncTaskGameplayTagChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UXIAsyncTaskGameplayTagChanged* ListenForGameplayTagAddedOrRemoved(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer Tags);
