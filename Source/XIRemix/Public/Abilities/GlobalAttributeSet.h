...
#pragma region PhysicalSubAttributes //Defines Attack, Accuracy, Defense, Evasion, Crits, and Movement
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, RangedAccuracy);
	UFUNCTION()
...
#pragma region ResistStatus //Defines Status resistances
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, AmnesiaResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, BindResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, BlindResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, GravityResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, ParalyzeResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, PetrifyResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, PoisonResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, SilenceResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, SleepResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, SlowResistance);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, VirusResistance);
	UFUNCTION()
...
#pragma region OtherAttributes
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, CurePotency);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, CureReceivedPotency);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, DamageResist);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, Enmity);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(UGlobalAttributeSet, SpellInterruption);
	UFUNCTION()
