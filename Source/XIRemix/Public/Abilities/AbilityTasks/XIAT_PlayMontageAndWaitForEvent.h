 ...
 */
UCLASS()
class XIREMIX_API UXIAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UXIAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	FXIPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FXIPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FXIPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FXIPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FXIPlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UXIAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
